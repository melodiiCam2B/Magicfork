...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Magicfork", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Magicfork", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "30";
		app.meta["company"] = "magic.Ffrk";
		app.meta["file"] = "Magicfork";
		app.meta["name"] = "Friday Night Funkin': Magicfork";
		app.meta["packageName"] = "com.forkmagic.game";
		app.meta["version"] = "Alpha 0.1";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Magicfork",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Friday Night Funkin': Magicfork";
		#else
