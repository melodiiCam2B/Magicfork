...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Vs Impostor", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Vs Impostor", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "Split Team";
		app.meta["file"] = "Vs Impostor";
		app.meta["name"] = "Friday Night Funkin': Vs. Impostor - Split";
		app.meta["packageName"] = "com.splitteam.impostor";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Vs. Impostor - Split",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Friday Night Funkin': Vs. Impostor - Split";
		#else
