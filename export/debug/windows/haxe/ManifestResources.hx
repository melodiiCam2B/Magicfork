...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_meta_io_github_shadowmario_fnf_psychengine_desktop extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_meta_io_github_shadowmario_fnf_psychengine_metainfo_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_meta_io_github_shadowmario_fnf_psychengine_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_split_images_background_stuff_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_split_images_lab_floor_wall_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_split_images_lab_objects_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_split_images_lab_overlay_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_translations_shared_data_pt_br_lang extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_translations_shared_images_pt_br_mainmenu_menu_credits_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_translations_shared_images_pt_br_mainmenu_menu_credits_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_translations_shared_images_pt_br_mainmenu_menu_story_mode_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_translations_shared_images_pt_br_mainmenu_menu_story_mode_xml extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_translations_shared_images_pt_br_menudifficulties_easy_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_translations_shared_images_pt_br_menudifficulties_hard_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_translations_shared_images_pt_br_menu_tracks_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_videos_put_your_videos_here_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_week_assets_readme_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_arrow_down_png1 extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_arrow_up_png1 extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_checkbox_png1 extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_dropdown_button_png1 extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_radio_png1 extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_stepper_minus_png1 extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_stepper_plus_png1 extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("assets/embed/images/psych-ui/arrow_down.png") @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_arrow_down_png1 extends lime.graphics.Image {}
@:keep @:image("assets/embed/images/psych-ui/arrow_up.png") @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_arrow_up_png1 extends lime.graphics.Image {}
@:keep @:image("assets/embed/images/psych-ui/checkbox.png") @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_checkbox_png1 extends lime.graphics.Image {}
@:keep @:image("assets/embed/images/psych-ui/dropdown_button.png") @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_dropdown_button_png1 extends lime.graphics.Image {}
@:keep @:image("assets/embed/images/psych-ui/radio.png") @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_radio_png1 extends lime.graphics.Image {}
@:keep @:image("assets/embed/images/psych-ui/stepper_minus.png") @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_stepper_minus_png1 extends lime.graphics.Image {}
@:keep @:image("assets/embed/images/psych-ui/stepper_plus.png") @:noCompletion #if display private #end class __ASSET__assets_embed_images_psych_ui_stepper_plus_png1 extends lime.graphics.Image {}
@:keep @:file("D:/code/Impostor-Split/.haxelib/flixel/5,6,1/assets/sounds/beep.ogg") @:noCompletion #if display private #end class __ASSET__flixel_sounds_beep_ogg extends haxe.io.Bytes {}
@:keep @:file("D:/code/Impostor-Split/.haxelib/flixel/5,6,1/assets/sounds/flixel.ogg") @:noCompletion #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends haxe.io.Bytes {}
@:keep @:font("D:/code/Impostor-Split/.haxelib/flixel/5,6,1/assets/fonts/nokiafc22.ttf") @:noCompletion #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends lime.text.Font {}
@:keep @:font("D:/code/Impostor-Split/.haxelib/flixel/5,6,1/assets/fonts/monsterrat.ttf") @:noCompletion #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends lime.text.Font {}
@:keep @:image("D:/code/Impostor-Split/.haxelib/flixel/5,6,1/assets/images/ui/button.png") @:noCompletion #if display private #end class __ASSET__flixel_images_ui_button_png extends lime.graphics.Image {}
@:keep @:image("D:/code/Impostor-Split/.haxelib/flixel/5,6,1/assets/images/logo/default.png") @:noCompletion #if display private #end class __ASSET__flixel_images_logo_default_png extends lime.graphics.Image {}
@:keep @:image("D:/code/Impostor-Split/.haxelib/flixel-addons/3,2,2/assets/images/transitions/circle.png") @:noCompletion #if display private #end class __ASSET__flixel_images_transitions_circle_png extends lime.graphics.Image {}
@:keep @:image("D:/code/Impostor-Split/.haxelib/flixel-addons/3,2,2/assets/images/transitions/diagonal_gradient.png") @:noCompletion #if display private #end class __ASSET__flixel_images_transitions_diagonal_gradient_png extends lime.graphics.Image {}
@:keep @:image("D:/code/Impostor-Split/.haxelib/flixel-addons/3,2,2/assets/images/transitions/diamond.png") @:noCompletion #if display private #end class __ASSET__flixel_images_transitions_diamond_png extends lime.graphics.Image {}
@:keep @:image("D:/code/Impostor-Split/.haxelib/flixel-addons/3,2,2/assets/images/transitions/square.png") @:noCompletion #if display private #end class __ASSET__flixel_images_transitions_square_png extends lime.graphics.Image {}
@:keep @:image("D:/code/Impostor-Split/.haxelib/flxanimate/git/assets/images/pivot.png") @:noCompletion #if display private #end class __ASSET__flxanimate_images_pivot_png extends lime.graphics.Image {}
@:keep @:image("D:/code/Impostor-Split/.haxelib/flxanimate/git/assets/images/indicator.png") @:noCompletion #if display private #end class __ASSET__flxanimate_images_indicator_png extends lime.graphics.Image {}
