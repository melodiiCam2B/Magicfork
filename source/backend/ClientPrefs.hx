...
@:structInit class SaveVariables {
	public var debugPos:Array<Float> = [10, 10];
	public var scriptDebug:Bool = true;
...
class ClientPrefs {
	...
	public static function loadPrefs() {
		...
		trace('last fps pos: ' + data.debugPos);
		if(Main.fpsVar != null) {
			Main.fpsVar.visible = data.showFPS;
			Main.fpsVar.x = data.debugPos[0];
			Main.fpsVar.y = data.debugPos[1];
		}
